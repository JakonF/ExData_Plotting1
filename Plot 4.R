...
# plot 4
png(filename = "E:\\My Documents\\Coursera\\In Progress\\Exploratory Data Analysis\\Course Project 1\\Plot4.png")
par(mfrow = c(2,2))
plot(epc_p$dt, epc_p$Global_active_power, type = "l", xlab = "",
     ylab = "Global Active Power (kilowatts)")

plot(epc_p$dt, epc_p$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
legend(x = "topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       col = c("black", "red", "blue"), lty = 1, bty = "n", y.intersp = .3,
       text.width = strwidth("Sub_metering_1") / 2)

plot(epc_p$dt, epc_p$Global_reactive_power, type = "l", xlab = "datetime",
